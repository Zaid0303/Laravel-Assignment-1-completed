...
<body>
    ...
    <header class="hero">
        <div class="hero-content">
            <h1>E-commerce Store - About</h1>
            <p>Our E-commerce About Section</p>
    ...
    <!-- About Section Start -->
    <div class="container">
        <h1 class="mt-3 text-center">Our Team</h1>

        <div class="row justify-content-lg-center mt-3">
            <div class="col-lg-4 col-md-6 bg-white border rounded shadow-sm overflow-hidden mt-3">
